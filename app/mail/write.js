...
export default  function Write(props){
  ...
  function Timer() {
    ...
    const iday = new Date(`2023/10/30 00:00:00`); // 입대일
    const sdday = new Date(`2023/12/01 00:00:00`); // 수료일
    const jdday = new Date(`2025/07/29 00:00:00`); // 전역일
