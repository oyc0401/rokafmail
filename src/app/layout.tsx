...
export const metadata = {
  title: "하늘인편 - 공군 인터넷편지",
  description:
    "하늘인편은 공군 훈련병에게 인터넷편지를 보내주는 사이트입니다. 입대 전 미리 링크를 만들어 사람들에게 공유하세요. 이젠 가족과 친구에게 인편지기를 부탁할 필요가 없습니다. 하늘인편이 인편지기가 되어드립니다. 또한 하늘인편은 입대 후 즉시 편지작성이 가능해서 더 많은 편지를 받아볼 수 있습니다.",
