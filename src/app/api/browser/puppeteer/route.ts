...
async function runCodeInBrowser() {
    ...
    await page.goto('https://www.airforce.mil.kr/user/indexSub.action?codyMenuSeq=156893223&siteId=last2&menuUIType=sub');
...
////////////////////////////////////////////////////////////////
      ...
      function extractInnerText(htmlString, className) {
        ...
        const innerTexts = Array.from(elements).map((element) => element.textContent);
