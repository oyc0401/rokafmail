...
import {startUserCron,stopUserCron, statusUserCron} from './dashboard_server'

import {CircularProgress} from "@nextui-org/react";

export default function CronStatusUser(){
  ...
  async function sync() {
    ...
    init();
    async function init(){
      const repeater =await statusUserCron();
  ...
  async function onclickStart() {
    await startUserCron(); // 프로그램 시작
    sync();
  }

  async function onclickStop() {
    await stopUserCron(); // 프로그램 중지
    sync();
  }
  ...
  return (
      ...
      <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
        ...
        <div className="mb-4 items-center">
          <h2 className="font-bold text-xl mb-2">User Cron Status</h2>
          <Status></Status>
